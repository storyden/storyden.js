...
export namespace NotificationListResponse {
  export interface Notification {
    ...
    item?:
      | Notification.DatagraphItemPost
      | unknown
      | Notification.DatagraphItemReply
      | Notification.DatagraphItemNode
      | Notification.DatagraphItemProfile;
...
export interface NotificationUpdateReadStatusResponse {
  ...
  item?:
    | NotificationUpdateReadStatusResponse.DatagraphItemPost
    | unknown
    | NotificationUpdateReadStatusResponse.DatagraphItemReply
    | NotificationUpdateReadStatusResponse.DatagraphItemNode
    | NotificationUpdateReadStatusResponse.DatagraphItemProfile;

  /**
   * A minimal reference to an account.
   */
  source?: NotificationUpdateReadStatusResponse.Source;
}
