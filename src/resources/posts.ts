...
export class Posts extends APIResource {
   ...
   */
  archive(postId: string, options?: Core.RequestOptions): Core.APIPromise<void> {
  ...
  reacts(
    postId: string,
    body?: PostReactsParams,
    options?: Core.RequestOptions,
  ): Core.APIPromise<PostReactsResponse>;
  reacts(postId: string, options?: Core.RequestOptions): Core.APIPromise<PostReactsResponse>;
  reacts(
    postId: string,
    body: PostReactsParams | Core.RequestOptions = {},
    options?: Core.RequestOptions,
  ): Core.APIPromise<PostReactsResponse> {
    if (isRequestOptions(body)) {
      return this.reacts(postId, {}, body);
    }
...
export interface PostReactsResponse {
  /**
   * A unique identifier for this resource.
   */
  id?: string;
...
export interface PostReactsParams {
  emoji?: string;
}
...
export namespace Posts {
  ...
  export import PostReactsResponse = PostsAPI.PostReactsResponse;
  export import PostSearchResponse = PostsAPI.PostSearchResponse;
  export import PostUpdateParams = PostsAPI.PostUpdateParams;
  export import PostReactsParams = PostsAPI.PostReactsParams;
