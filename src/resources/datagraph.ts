...
export interface DatagraphQueryResponse {
  ...
  items: Array<
    | DatagraphQueryResponse.DatagraphItemPost
    | unknown
    | DatagraphQueryResponse.DatagraphItemReply
    | DatagraphQueryResponse.DatagraphItemNode
    | DatagraphQueryResponse.DatagraphItemProfile
  >;
