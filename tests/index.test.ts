...
describe('instantiate client', () => {
  ...
  test('explicit global fetch', async () => {
    ...
    const client = new Storyden({ baseURL: 'http://localhost:5000/', fetch: defaultFetch });
  });
  ...
  test('normalized method', async () => {
    ...
    const client = new Storyden({ baseURL: 'http://localhost:5000/', fetch: testFetch });
  ...
  describe('baseUrl', () => {
    ...
    afterEach(() => {
      process.env['STORYDEN_BASE_URL'] = undefined;
    });
    ...
    test('in request options overridden by client options', () => {
      const client = new Storyden({ baseURL: 'http://localhost:5000/client' });
      expect(client.buildURL('/foo', null, 'http://localhost:5000/option')).toEqual(
    ...
    test('in request options overridden by env variable', () => {
      process.env['STORYDEN_BASE_URL'] = 'http://localhost:5000/env';
      const client = new Storyden({});
      expect(client.buildURL('/foo', null, 'http://localhost:5000/option')).toEqual(
...
describe('retries', () => {
  ...
  test('retry count header', async () => {
    ...
    const client = new Storyden({ fetch: testFetch, maxRetries: 4 });
