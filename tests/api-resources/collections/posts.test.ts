...
describe('resource posts', () => {
  ...
  test.skip('add', async () => {
    const responsePromise = client.collections.posts.add(
  ...
  test.skip('add: request options instead of params are passed correctly', async () => {
    ...
    await expect(
      client.collections.posts.add('cc5lnd2s1s4652adtu50-top-10-movies-thread', 'cc5lnd2s1s4652adtu50', {
  ...
  test.skip('remove', async () => {
    const responsePromise = client.collections.posts.remove(
      'cc5lnd2s1s4652adtu50-top-10-movies-thread',
      'cc5lnd2s1s4652adtu50',
    );
    const rawResponse = await responsePromise.asResponse();
  ...
  test.skip('remove: request options instead of params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(
      client.collections.posts.remove('cc5lnd2s1s4652adtu50-top-10-movies-thread', 'cc5lnd2s1s4652adtu50', {
        path: '/_stainless_unknown_path',
      }),
    ).rejects.toThrow(Storyden.NotFoundError);
  });
