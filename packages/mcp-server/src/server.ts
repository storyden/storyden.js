...
import { ClientOptions } from 'Storyden';
...
export { ClientOptions } from 'Storyden';
...
export function initMcpServer(params: {
  ...
  const client = new Storyden(params.clientOptions);
  const capabilities = {
    ...defaultClientCapabilities,
...
export function init(params: {
  ...
  const client = params.client || new Storyden({ defaultHeaders: { 'X-Stainless-MCP': 'true' } });
